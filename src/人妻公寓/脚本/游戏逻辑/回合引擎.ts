...
function 回合结算(
  ...
  const 提交本轮事件 = () => {
    ...
    if (许曼君离婚后日常票) {
      ...
      if (演员错误) throw new Error(演员错误);
      const 正文错误 = 许曼君离婚后日常正文越界原因(本楼事件, 正文);
...
export async function 执行回合(
  ...
  try {
    ...
    const 专属节拍错误 =
      不再留门正文越拍原因(本楼事件, 当前拍正文) ||
      第二机位正文越拍原因(本楼事件, 当前拍正文) ||
      安若妍不必停正文越拍原因(本楼事件, 当前拍正文) ||
      许曼君分居正文越拍原因(本楼事件, 当前拍正文) ||
      许曼君离婚正文越拍原因(本楼事件, 当前拍正文) ||
      许曼君离婚后日常正文越界原因(本楼事件, 当前拍正文) ||
      回国正文越拍原因(本楼事件, 当前拍正文) ||
      双重继承正文越拍原因(本楼事件, 当前拍正文);
