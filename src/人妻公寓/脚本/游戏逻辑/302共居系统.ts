...
export function 母亲共居玩家私聊纪律(data: SchemaType): string {
  if (!双重继承完成事实(data)) return '';
  return (
    '【302共居·玩家主动私聊】先回应玩家当前消息。私聊可以明确讨论想念、成人邀请、上次真实场次的余韵与边界，也可以谈起双方确实经历过的旧事；父亲始终不知情。' +
  ...
  return [
    {
      role: 'system',
      content:
        '【已封存章节】《回国》与《双重继承》的检查、交权、三日早餐、机场视频和总钥匙收束已经完成。双方可以回忆确实经历过的旧事；旧楼仍供玩家查看与回档，但不再作为当前场景继续演出。当前行动按302结局后自由阶段及其他尚未完成的现实线路继续。',
    },
    ...历史,
  ];
}
