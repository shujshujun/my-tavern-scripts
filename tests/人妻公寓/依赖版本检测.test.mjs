...
test('游戏当前版本固定为 0.92.2，最新版只接受官方 rq 稳定标签', () => {
  ...
  assert.equal(当前游戏版本, '0.92.2', '下一次发布必须显式更新游戏本体版本');
  assert.equal(当前游戏版本, 组卡版本, '游戏检测版本必须与角色卡展示版本一致');
  assert.equal(当前游戏版本, 组卡标签, '游戏检测版本必须与角色卡资源标签一致');
  assert.equal(
    选择最新游戏稳定版本({
      versions: ['xdy0.99', 'v9.0', '0.90.1', 'rq0.83', 'rq0.84', 'rq0.85', 'rq0.86', 'rq0.87', 'rq0.88', 'rq0.89', 'rq0.90', 'rq0.90.1', 'rq0.90.2', 'rq0.90.3', 'rq0.90.4', 'rq0.91', 'rq0.91.2', 'rq0.91.3', 'rq0.91.4', 'rq0.91.5', 'rq0.91.6', 'rq0.92', 'rq0.92.1', 'rq0.92.1-beta', 'rq0.92.1-rc.1', 'rq0.92.1-dev', 'rq0.9'],
    }),
    '0.92.1',
  );
  assert.equal(
    选择最新游戏稳定版本([
      ...
      { ref: 'refs/tags/rq0.90' },
      { ref: 'refs/tags/rq0.90.1' },
      { ref: 'refs/tags/rq0.90.2' },
      { ref: 'refs/tags/rq0.90.3' },
      { ref: 'refs/tags/rq0.90.4' },
      { ref: 'refs/tags/rq0.91' },
      { ref: 'refs/tags/rq0.91.2' },
      { ref: 'refs/tags/rq0.91.3' },
      { ref: 'refs/tags/rq0.91.4' },
      { ref: 'refs/tags/rq0.91.5' },
      { ref: 'refs/tags/rq0.91.6' },
      { ref: 'refs/tags/rq0.92' },
      { ref: 'refs/tags/rq0.92.1' },
...
test('稳定版本解析严格区分正式版、预发布版与当前高于远端缓存的状态', () => {
  ...
  assert.equal(比较稳定版本('0.90', '0.90'), '相同', '玩家已经是 0.90 时绝不能提示还有 0.90 更新');
  assert.equal(比较稳定版本('0.90', '0.90.1'), '当前较旧', '0.90 玩家必须检测到 0.90.1 热修');
  assert.equal(比较稳定版本('0.90.1', '0.90.1'), '相同', '0.90.1 玩家不得重复提示同版更新');
  assert.equal(比较稳定版本('0.90.1', '0.90.2'), '当前较旧', '0.90.1 玩家必须检测到 0.90.2 热修');
  assert.equal(比较稳定版本('0.90.2', '0.90.3'), '当前较旧', '0.90.2 玩家必须检测到 0.90.3 热修');
  assert.equal(比较稳定版本('0.90.3', '0.90.4'), '当前较旧', '0.90.3 玩家必须检测到 0.90.4 更新');
  assert.equal(比较稳定版本('0.90.4', '0.90.4'), '相同', '0.90.4 玩家不得重复提示同版更新');
  assert.equal(比较稳定版本('0.90.4', '0.91'), '当前较旧', '0.90.4 玩家必须检测到 0.91 正式版');
  assert.equal(比较稳定版本('0.91', '0.91'), '相同', '0.91 历史同版比较仍须稳定');
  assert.equal(比较稳定版本('0.91', '0.91.2'), '当前较旧', '0.91 玩家必须检测到 0.91.2 热修');
  assert.equal(比较稳定版本('0.91.2', '0.91.2'), '相同', '0.91.2 历史同版比较仍须稳定');
  assert.equal(比较稳定版本('0.91.2', '0.91.3'), '当前较旧', '0.91.2 玩家必须检测到 0.91.3 热修');
  assert.equal(比较稳定版本('0.91.3', '0.91.3'), '相同', '0.91.3 历史同版比较仍须稳定');
  assert.equal(比较稳定版本('0.91.3', '0.91.4'), '当前较旧', '0.91.3 玩家必须检测到 0.91.4 热修');
  assert.equal(比较稳定版本('0.91.4', '0.91.4'), '相同', '0.91.4 历史同版比较仍须稳定');
  assert.equal(比较稳定版本('0.91.4', '0.91.5'), '当前较旧', '0.91.4 玩家必须检测到 0.91.5 热修');
  assert.equal(比较稳定版本('0.91.5', '0.91.5'), '相同', '0.91.5 历史同版比较仍须稳定');
  assert.equal(比较稳定版本('0.91.5', '0.91.6'), '当前较旧', '0.91.5 玩家必须检测到 0.91.6 热修');
  assert.equal(比较稳定版本('0.91.6', '0.91.6'), '相同', '0.91.6 玩家不得重复提示同版更新');
  assert.equal(比较稳定版本('0.91.6', '0.91.5'), '当前较新', '远端缓存落后时不得把 0.91.6 玩家误判为需要降级');
  assert.equal(比较稳定版本('0.91.6', '0.92'), '当前较旧', '0.91.6 玩家必须检测到 0.92 正式版');
  assert.equal(比较稳定版本('0.92', '0.92'), '相同', '0.92 历史同版比较仍须稳定');
  assert.equal(比较稳定版本('0.92', '0.91.6'), '当前较新', '0.92 对旧缓存不得提示降级');
  assert.equal(比较稳定版本('0.91.6', '0.92.1'), '当前较旧', '0.91.6 玩家必须检测到 0.92.1 热修');
  assert.equal(比较稳定版本('0.92', '0.92.1'), '当前较旧', '0.92 玩家必须检测到 0.92.1 热修');
  assert.equal(比较稳定版本('0.92.1', '0.92.1'), '相同', '0.92.1 玩家不得重复提示同版更新');
  assert.equal(比较稳定版本('0.92.1', '0.92'), '当前较新', '远端缓存落后时不得把 0.92.1 玩家误判为需要降级');
