...
test('0.91.4 历史发布说明保持冻结，当前源码、组卡与入口前进到0.91.5', () => {
  ...
  assert.match(依赖版本, /当前游戏版本 = '0\.91\.5'/);
  assert.match(组卡, /const 版本 = '0\.91\.5'/);
  assert.match(组卡, /const TAG = 'rq0\.91\.5'/);
  assert.match(组卡, /支持继承 v0\.80～v0\.91\.4 存档/);
  assert.match(入口, /v0\.91\.5／rq0\.91\.5/);
