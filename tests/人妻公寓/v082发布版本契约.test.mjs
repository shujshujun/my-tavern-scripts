...
test('0.82 发布标签、卡体版本、孕态资源与存档契约保持一致', () => {
  ...
  assert.match(组卡, /const TAG = 'rq0\.82'/);
  assert.match(组卡, /const 版本 = '0\.82'/);
  assert.match(资源, /@rq0\.82\/output\/imagegen\/rqgy-reset\/pregnancy-portraits\/approved/);
