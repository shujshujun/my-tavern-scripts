...
export function createTickHost(options = {}) {
  ...
  const deps = {
    ...
    孕产姐妹群必达拍: noContent, 生成302公开交接朋友圈: async () => false,
    ...
    排队刷新微信进展摘要: inert, 排队刷新群聊进展摘要: inert,
    荣耀洞专属动态: context => e.specialProducer ? e.specialProducer(context) : noContent(), 母亲共居事件朋友圈: noContent, 朋友圈近期流: noContent,
    主动私聊: async context => {
      e.producerCalls++;
