...
const 当前入口说明 = 读('src/人妻公寓/归档/新窗口入口_2026-09-14.md');
...
test('当前存档错误按数据版本说明兼容范围，并且维护说明不再声称正文变量路线仍需覆盖', () => {
  assert.match(存档结构, /当前版本仅兼容数据版本 7、8 和 9/);
  assert.doesNotMatch(存档结构, /v0\.86 仅兼容数据版本/);
  assert.match(存档结构, /受支持的旧存档可直接继承/);
